...
('Garden Veggie', 'Bell peppers, onions, mushrooms, black olives, and fresh tomatoes.', 13.99, 'https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&q=80&w=800', 'veggie'),
('BBQ Chicken', 'Grilled chicken, red onions, cilantro, and tangy BBQ sauce.', 15.99, 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&q=80&w=800', 'premium'),
...
('Spicy Diavola', 'Spicy salami, chili flakes, mozzarella, and hot honey drizzle.', 16.99, 'https://images.unsplash.com/photo-1593504049359-74330189a355?auto=format&fit=crop&q=80&w=800', 'classic');
